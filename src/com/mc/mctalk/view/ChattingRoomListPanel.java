...
public class ChattingRoomListPanel extends JPanel {
	...
	public void initPanel() {
		...
		scrollPane = new CustomJScrollPane(jlChattingRoomList, scrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				scrollPane.HORIZONTAL_SCROLLBAR_NEVER, true);
	...
	class FriendsListCellRenderer extends JPanel implements ListCellRenderer<ChattingRoomVO> {
		...
		@Override
		public Component getListCellRendererComponent(JList<? extends ChattingRoomVO> list, ChattingRoomVO value,
